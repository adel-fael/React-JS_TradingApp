...
export const StockChart = ({ chartData, symbol }) => {
  ...
  /* Determining the color of the chart based on the first and last value of the data. If the last value
is greater than the first value, the color is green, otherwise it is red. */
  const color =
